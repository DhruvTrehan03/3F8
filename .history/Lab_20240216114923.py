...
def fit_w(X_tilde_train, y_train, X_tilde_test, y_test, n_steps, alpha):
    ...
    for i in range(n_steps):
        ...
        np.print(np.shpae(X_tilde_train.T*(y_train-sigmoid_value)))
        w += alpha * np.sum((X_tilde_train.T*(y_train-sigmoid_value)), axis=0)     # Gradient-based update rule for w. To be completed by the student
