...
def fit_w(X_tilde_train, y_train, X_tilde_test, y_test, n_steps, alpha):
    ...
    for i in range(n_steps):
        ...
        w += alpha * np.sum(X_tilde_train.T*(y_train-sigmoid_value))     # Gradient-based update rule for w. To be completed by the student
...
print(fit_w(X_train, y_train, X_test, y_test, Max_it, Eta))