    ...
    for i in range(len(y_test)):
        ...
        if y_test[i] == 1:
            if z[i] == 0:
                ...
                P_1_1 += 1
    print(np.array([[P_0_0/200, P_1_0/200],[P_0_1/200, P_1_1/200]]))
...
l = 0.01 # Width of the Gaussian basis funcction. To be completed by the student
...
alpha = 0.00001 # Learning rate for gradient-based optimisation with basis functions. To be completed by the student
n_steps = 100 # Number of steps of gradient-based optimisation with basis functions. To be completed by the student
