...
print((predict(X_tilde_test, w)>0.5).sum(), "Guessed 1")
print((predict(X_tilde_test, w)<0.5).sum(), "Guessed 0")
print((y_test==0).sum(), "Num Class 0")
print((y_test==1).sum(), "Num Class 1")